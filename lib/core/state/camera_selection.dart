// Camera selection state — active camera ID is set by the discovery flow on a
// successful connect and cleared on disconnect. Cross-feature providers
// (consumed by core controllers/widgets and several features), so they live
// in core/state per the layering convention; features/camera/camera_state.dart
// re-exports this file for the historical import path.
