...
//
// The immutable model + event codecs live in live_match_models.dart
// (re-exported below); this file owns the controller, the finalize path and
// the firmware-sync providers.
...
class LiveMatchController extends Notifier<LiveMatchState> {
  ...
  void loadFromUpcoming({
    ...
    final away = opponentDisplayName(opponent);
